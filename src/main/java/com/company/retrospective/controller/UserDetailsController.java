...
public class UserDetailsController {
	...
	@GetMapping()
	@CrossOrigin(origins = "*")
	public ResponseEntity<UserDetails> getUserDetailsByToken(@RequestHeader(value = "Authorization", required = true) String authorization) {
		
		System.out.println("Request for Get User Details with token");
